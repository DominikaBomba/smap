...
export const events = {
    ptpn: {
        tag: "już 02.10.2026!",
        title: "Wystąpienie podczas Ogólnopolskiej Konferencji Pielęgniarek Neurologicznych",
        image: konferencja,
        alt: "photo from the nursing conference",
        short:
            "Już w październiku 2026 roku Dominika opowie o etycznym korzystaniu z LLM-ów oraz prywatności danych pacjentów.",
        full: [
    ...
    gfr: {
        tag: "31.07.2026 zapraszamy:)",
        title: "Organizujemy finał projektu Herstory by Girls Future Ready ",
        image: gfr,
        alt: "photo from the gfr conference",
        short:
            "31 lipca 2026 roku przeprowadzimy warsztaty dla młodych kobiet o technologii w medycynie na finale programu HerStory - na przykładzie naszego projektu.",
        full: [
    ...
    hba: {
        tag: "15.06.2026 - HBA Warsaw Branch",
        title: "Wystąpienie na spotkaniu ”The Power of Mentoring” by HBA",
        image: hbaImg,
    ...
    smicoztego: {
        tag: "22-24.05.2026 Konferencja pacjencka",
        title: "Byłyśmy na konferencji „SM – i co z tego?”",
        image: smicoztego,
        alt: "photo from the SM - i co z tego? conference",
        short:
            "Wziełyśmy udział w dniu eksperckim i dniach pacjenckich Ogólnopolskiej Konferencji",
        full: [
